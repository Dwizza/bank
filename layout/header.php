...
<nav
  ...
  <div class="flex w-full flex-wrap items-center justify-between px-3">
    ...
    <div
      ...
      <!-- Logo -->
      <a
        class="mb-2 me-3 ms-2 mt-3 flex items-center text-neutral-900 hover:text-neutral-900 focus:text-neutral-900 dark:text-neutral-200 dark:hover:text-neutral-400 dark:focus:text-neutral-400 lg:mb-0 lg:mt-0"
        href="#">
        <img
          src="./logo/pngwing.com (6).png"
          style="height: 15px"
          alt="TE Logo"
          loading="lazy" />
      </a>
